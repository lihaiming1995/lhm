...
<html>
	...
	<body>
		...
		<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
		  	<tr valign="top">
			    <td>
			    <form id="noticeForm" name="noticeForm" action="${pageContext.request.contextPath }/NoticeControll" method="post">
				  <!-- 隐藏表单，flag表示添加标记 -->
				  ...
				  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
					    <tr><td class="font3 fftd">
					                公告标题：<input type="text" name="nTitle" size="30" id="nTitle" value="${notice.nTitle}"/>
						...
						<tr><td class="font3 fftd">公告内容：<br/>
							<textarea name="nContent" cols="88" rows="11" id="nContent" >${notice.nContent }</textarea>
						</td></tr>
						<tr><td class="main_tdbor"></td></tr>
