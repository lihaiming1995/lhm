...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/UserControll?method=updated" id="userForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">姓名：<input type="text" name="uName" id="uName" size="20" value="${user.uName}"/></td>
		    			<td class="font3 fftd">状态：<input type="text" name="uState" id="uState" size="20" value="${user.uState}"/></td>
		    		</tr>
		    			
		    		<tr>
		    			<td class="font3 fftd">登录名：<input name="uLoginName" id="uLoginName" size="20" value="${user.uLoginName }"/></td>
