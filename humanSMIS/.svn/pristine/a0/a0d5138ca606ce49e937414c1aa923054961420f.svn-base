...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/JobControll" id="jobForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
    	 	<input type="hidden" name="flag" value="2">
    	 	<input type="hidden" name="method" value="updated"value="2">
    	 	<input type="hidden" name="jId" value="${job.jId }">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">部门名称：<input type="text" name="jName" id="jName" size="20" value="${job.jName }"/></td>
		    			<td class="font3 fftd">详细描述：<input type="text" name="jDes" id="jDes" size="20" value="${job.jDes }"/></td>
		    		</tr>
