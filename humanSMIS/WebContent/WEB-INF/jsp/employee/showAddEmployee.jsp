...
<body>
	...
	<table width="100%" height="90%" border="0" cellpadding="5"
		...
		<tr valign="top">
			<td>
				<form action="${pageContext.request.contextPath}/EmployeeControll"
					id="employeeForm" method="post">
					<!-- 隐藏表单，flag表示添加标记 -->
					<input type="hidden" name="method" value="added"> <input
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="10"
								...
								<table>
									<tr>
										...
										<td class="font3 fftd">身份证号码：<input type="text"
											name="eIdCard" id="eIdCard" size="20" /></td>
									</tr>
									<tr>
										<td class="font3 fftd">性别： <select name="eGender"
											style="width: 143px;">
									...
									<tr>
										<td class="font3 fftd">学历：<input name="eStu" id="eStu"
											size="20" /></td>
										<td class="font3 fftd">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：<input
											name="eEmail" id="eEmail" size="20" /></td>
									</tr>
									<tr>
										<td class="font3 fftd">手机：<input name="eTelNum"
											id="eTelNum" size="20" /></td>
						...
						<tr>
							<td class="font3 fftd">
								...
								QQ&nbsp;&nbsp;号码：<input name="eQQNum" id="eQQNum" size="20" />
							</td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
						...
						<tr>
							<td class="font3 fftd">联系地址：<input name="eAddress"
								id="eAddress" size="40" />&nbsp;&nbsp; 邮政编码：<input
								name="ePostCode" id="ePostCode" size="20" />
							</td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
						...
						<tr>
							<td class="font3 fftd">出生日期：<input cssClass="Wdate"
								...
								name="eBirthday" id="eBirthday" size="40" />&nbsp;&nbsp;
						...
						<tr>
							<td class="font3 fftd">备&nbsp;&nbsp;&nbsp;&nbsp;注：<input
								name="eDes" id="eDes" size="40" /> &nbsp;&nbsp;所属部门：
