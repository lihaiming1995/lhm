...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/DeptControll" id="deptForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<!-- <td class="font3 fftd">部门id：<input type="text" name="dId" id="dId" size="10"/></td> -->
		    			<td class="font3 fftd">部门名称：<input type="text" name="dName" id="dName" size="20"/></td>
		    			<td class="font3 fftd">详细描述：<input type="text" name="dDes" id="dDes" size="20"/></td>
		    		</tr>
