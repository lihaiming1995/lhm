	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除部门",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
	 					   window.location = "${pageContext.request.contextPath }/DeptControll?method=delete&dId=" + ids.get();
	 				   }
	 			   });
	 		   }
	 	   })
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="deptform" method="post" id="deptform" action="${pageContext.request.contextPath}/dept/selectDept">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
			...
			<c:forEach items="${depts}" var="dept" varStatus="stat">
				<tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
					<td><input type="checkbox" id="box_${stat.index}" value="${dept.dId}"></td>
					 <td>${dept.dName}</td>
					  <td>${dept.dDes}</td>
					 <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/DeptControll?method=update&flag=1&dId=${dept.dId}">
