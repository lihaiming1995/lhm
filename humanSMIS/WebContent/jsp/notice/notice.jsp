	...
	$(function(){
	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除公告",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
	 					   window.location = "${pageContext.request.contextPath }/NoticeControll?method=delete&nId="+ids.get();
	 				   }
	 			   });
	 		   }
	 	   })
		...
		$("a[id^='prev_'").click(function(){
			...
			$.ligerDialog.open({ 
				title:'预览公告',
				height: 500, 
				url: '${pageContext.request.contextPath}jsp/notice/previewNotice.jsp?id='+noticeId, 
				width: 750, 
				showMax: true, 
				showToggle: true, 
				showMin: true, 
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="noticeform" method="post" id="noticeform" action="${pageContext.request.contextPath}/notice/selectNotice">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
				...
				<tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
					<td><input type="checkbox" id="box_${stat.index}" value="${notice.nId}"></td>
					 ...
					 <td align="center" width="40px;"><a
								href="${pageContext.request.contextPath }/NoticeControll?method=update&flag=1&nId=${notice.nId}">
									<img title="修改"
