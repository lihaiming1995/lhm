	...
	<script type="text/javascript">
	    $(function(){
	    	...
	    	$("a[id^='down_']").click(function(){
	    		/** 得到需要下载的文档的id */
	    		var id = this.doId.replace("down_","");
	    		/** 下载该文档 */
	    		window.location ="${pageContext.request.contextPath}/DownloadControll?method=download&doId="+id;
	    	})
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="documentform" method="post" id="documentform" action="${pageContext.request.contextPath}/document/selectDocument">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
			...
			<c:forEach items="${documents}" var="document" varStatus="stat">
				<tr ondblclick="down(${document.doId});"  class="main_trbg" align="center" id="data_${stat.index}">
					<td><input type="checkbox" id="box_${stat.index}" value="${document.doId}"></td>
					 ...
					 <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/DownloadControll?flag=1&doId=${document.doId}">
							<img title="修改" src="${pageContext.request.contextPath}/images/update.gif"/></a>
					  </td>
					   <!--使用jstl老构建路径-->
					  <c:url var="download" value="/DownloadControll">
					     <c:param name="method" value="down"></c:param>
					     <c:param name="filePath" value="${document.filePath}"></c:param>
					  </c:url>
					  
					  
					  <td align="center"  width="40px;"><a href="${download}">
